# Testing our ability to run sims on Colby's nscc-n3 cluster.
# Mimick Fig-6.1to6.3-data-16-07-19.R, which should be relatively cheap...
...
simSettingsList = list(nrSims = nrSims,
                       p = c(11L, 50L, 250L),
                       n = c(50L, 250L, 1250L),
                       K = c(3L, 5L, 10L),
                       muFactor = c(1L, 5L),
